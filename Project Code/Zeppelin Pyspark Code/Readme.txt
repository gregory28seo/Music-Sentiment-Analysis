Zeppelin Project PySpark Code Import Instructions:

1. Music Mood Analysis 1, Music Mood Analysis 2 and Music Mood Analysis 3 are the different approaches we tried with all possible combinations of features to check which one gives a better accuracy while training the ML model.
